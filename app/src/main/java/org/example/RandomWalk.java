...
public class RandomWalk {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            incrementGreen(currentRow, currentColumn);
            randomMove();
    ...
    static void incrementGreen(int row, int col) {
        int greenComp = Mosaic.getGreen(row, col);
        int redComp = Mosaic.getRed(row, col);
        int blueComp = Mosaic.getBlue(row, col);
        greenComp += 25;
        greenComp = (greenComp > 255) ? 255 : greenComp;
        Mosaic.setColor(row, col, redComp, greenComp, blueComp);
    }
